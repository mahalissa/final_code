"""
Tailgating analyser for traffic cameras.

The heuristic implements the **two-second rule** from
...
class TailgatingAnalyzer:
    """2-second-rule traffic heuristic."""
    ...
    def _analyse_traffic(
        ...
        than the other (different depths, so almost certainly
